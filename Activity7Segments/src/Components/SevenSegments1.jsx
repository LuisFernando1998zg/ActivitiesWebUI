...
const SevenSegments1 = ({ digit }) => {
    const segments = segment[digit] || [false, false, false, false, false, false, false];

    return (
        <><h2>Primer Parte</h2>
            <section className='container'>
                <section className="segmentsdisplay">
                    <aritcle className={`segment a ${segments[0] ? 'on' : 'off'}`}></aritcle>
                    ...
                    <aritcle className={`segment e ${segments[4] ? 'on' : 'off'}`}></aritcle>
